...
const FALLBACK_ITEMS: BehanceMediaItem[] = [
  {
    ...
    imageUrl: '/images/lifestyle-living-room-01.png',
  ...
  },
  {
    ...
    imageUrl: '/images/editorial-heritage-v1.png',
    projectUrl: 'https://www.behance.net/wovenwarp',
  ...
  },
  {
    ...
    category: 'Wool & Yarn',
    imageUrl: '/images/material-yarn-bundles-01.png',
    projectUrl: 'https://www.behance.net/wovenwarp',
  ...
  },
  {
    ...
    imageUrl: '/images/craft-handknotting-01.png',
    projectUrl: 'https://www.behance.net/wovenwarp',
